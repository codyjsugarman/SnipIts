...
class EventSplashPage: UIViewController, UIPopoverPresentationControllerDelegate{
...
//        self.dismissViewControllerAnimated(true, completion: {})
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        let viewRallyEvent = segue.destinationViewController as! ViewRallyEvent
        viewRallyEvent.tabBarController!.tabBar.userInteractionEnabled = true
    }

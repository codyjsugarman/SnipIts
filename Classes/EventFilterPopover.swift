...
class EventFilterPopover: UIViewController, UIPopoverPresentationControllerDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    
    @IBOutlet weak var filterPicker: UIPickerView!
    let filterPickerOptions = ["No Filter","My Events"]
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        viewRallyEventFeed.currentFilter = filter
        viewRallyEventFeed.refreshEventFeedFilter()
    }
